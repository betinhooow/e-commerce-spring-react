...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p3 = new Produto(null, "Mesa", 30.00);
		Produto p4 = new Produto(null, "Toalha", 4.00);
		Produto p5 = new Produto(null, "Colcha", 10.00);
		Produto p6 = new Produto(null, "TV true color", 220.00);
		Produto p7 = new Produto(null, "Roçadeira", 280.00);
		Produto p8 = new Produto(null, "Abajour", 480.00);
		Produto p9 = new Produto(null, "Pendente", 380.00);
		Produto p10 = new Produto(null, "Shampoo", 180.00);
		Produto p11 = new Produto(null, "Camisa", 80.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "rnobre.dev1@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123456a!"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "rnobre.dev@gmail.com", "47302478848", TipoCliente.PESSOAFISICA, pe.encode("123456a!"));
		cli2.getTelefones().addAll(Arrays.asList("1233323", "5345234"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avasdasd Masdaos", "125", "Sala 822", "Centro", "3337012", cli2, c2);
